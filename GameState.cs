...
namespace Common
{
    ...
    public class GameState
    {
        ...
        /// </summary>
        private readonly SetBoard board;
        ...
        public bool CheckIfLegal(int slot)
        {
            bool isTrue = false;
            isEaten = false;
        ...
        public bool CheckOpponentLegalPlays(int piece)
        {
            ...
            ServiceLocator.GetService<GameData>().PlayerLegalPlays
                = PlayerLegalPlays;
